...
<div class="admin-main-card">
    ...
    <!-- Export & Filter controls placed subtly at bottom or in a cleaner way -->
    <div style="margin-top: 3rem; display: flex; justify-content: space-between; align-items: center; border-top: 1px solid #eee; padding-top: 2rem;">
        <a href="export.php?type=pioneers" class="cta-btn-green" style="width: auto; padding: 0.8rem 2rem; border-radius: 12px; font-size: 0.95rem;">تصدير بيانات CSV</a>
