...
<head>
  ...
  <title>استبيان فحص ضغط الدم</title>
  <meta name="description" content="استبيان طبي لتقييم ضغط الدم - حياء فارماسي" />
  <style>
    @font-face {
...
<div class="page">
  ...
  <div class="upper-header">
    <div class="header-title-box">
      <img src="../assets/images/bar.svg" class="header-icon-svg" alt="" />
      <h1 class="header-title">استبيان فحص ضغط الدم</h1>
    </div>
  </div>
  ...
  <div class="card" role="main">
    <div class="card-body">
      <form id="surveyForm" method="POST" style="width: 100%; display: flex; flex-direction: column; align-items: center; flex: 1;">
        <input type="hidden" name="survey_answer" id="survey_answer" value="<?= isset($_SESSION['survey_responses']['vitamin-appetite.php']) ? $_SESSION['survey_responses']['vitamin-appetite.php'] : '' ?>">

        <h2 class="question">هل تمارس أقل من <span class="num">150</span> دقيقة من النشاط البدني أسبوعيًا؟</h2>

        <!-- Yes / No Options in Row -->
        <div class="options-row">
          <!-- نعم -->
          <button type="button" class="opt-btn <?= (isset($_SESSION['survey_responses']['vitamin-appetite.php']) && $_SESSION['survey_responses']['vitamin-appetite.php'] == 'yes') ? 'on' : '' ?>" onclick="selectSingle(this, 'yes')" id="opt-yes">
            <span class="opt-check"></span>
            <span class="opt-label">نعم</span>
          </button>

          <!-- لا -->
          <button type="button" class="opt-btn <?= (isset($_SESSION['survey_responses']['vitamin-appetite.php']) && $_SESSION['survey_responses']['vitamin-appetite.php'] == 'no') ? 'on' : '' ?>" onclick="selectSingle(this, 'no')" id="opt-no">
            <span class="opt-check"></span>
